...
class IndexNavbar extends React.Component {
    ...
    handleSubmit(e){
        if(e.key==='Enter'){
            ...
            this.props.updateFilter('location', e.target.value).then(this.props.history.push('/spots'));
        ...
        render(){
            ...
            const display = this.props.currentUser ? (
                <div className='idx-navbar'>
                    <button className='idx-navbut' onClick={()=> this.props.history.push('/myAccount')}>My Account</button>
            ...
            <div className="idxnav-container">
                <div className='search'>
                    ...
                    <form>
                        ...
                        <input type="text" placeholder='Try New York' onKeyPress={this.handleSubmit}/>
                    </form>
                </div>
...
export default withRouter(connect(msp,mdp)(IndexNavbar))